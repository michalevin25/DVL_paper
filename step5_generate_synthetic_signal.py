...
TRAJECTORIES = [
    ...
    #
    # Amplitudes calibrated to real A-KIT curvature distribution (p90 per axis):
    #   vx: strong=0.23  medium=0.15   (training p90=0.23, max=1.28)
    #   vy: strong=0.86  medium=0.50   (training p90=0.86, max=4.66)
    #   vz: strong=2.17  medium=1.50   (training p90=2.17, max=3.74)
    #
    ...
    dict(id=3,  desc="Backward-lateral, spiky vz, early",
         ...
         peaks_vx=[],                       peaks_vy=[],                       peaks_vz=[(40, 2.17)],
    ...
    dict(id=4,  desc="Near-hover, explosive all axes",
         ...
         peaks_vx=[(40, 0.23)],             peaks_vy=[(40, 0.86)],             peaks_vz=[(40, 2.17)],
    ...
    dict(id=5,  desc="High-speed forward, spiky vx",
         ...
         peaks_vx=[(103, 0.23)],            peaks_vy=[],                       peaks_vz=[],
    ...
    dict(id=7,  desc="Forward-starboard, spiky vx, late",
         ...
         peaks_vx=[(165, 0.23)],            peaks_vy=[],                       peaks_vz=[],
    ...
    dict(id=8,  desc="Port drift, two horizontal maneuvers",
         ...
         peaks_vx=[(40, 0.23),(165, 0.23)], peaks_vy=[(40, 0.86),(165, 0.86)], peaks_vz=[],
    ...
    dict(id=9,  desc="Slow creep, late horizontal maneuver",
         ...
         peaks_vx=[(165, 0.23)],            peaks_vy=[(165, 0.86)],            peaks_vz=[],
    ...
    dict(id=10, desc="Backward-vz, spiky vz, mid+late",
         ...
         peaks_vx=[],                       peaks_vy=[],                       peaks_vz=[(103, 2.17),(165, 2.17)],
    ...
    dict(id=11, desc="Lateral, very spiky, three turns",
         ...
         peaks_vx=[(35, 0.23),(103, 0.15),(170, 0.23)], peaks_vy=[(35, 0.86),(103, 0.50),(170, 0.86)], peaks_vz=[],
    ...
    dict(id=12, desc="Forward, spiky vz, mid maneuver",
         ...
         peaks_vx=[],                       peaks_vy=[],                       peaks_vz=[(103, 2.17)],
    ...
    dict(id=13, desc="Near-hover, spiky vx, three turns",
         ...
         peaks_vx=[(35, 0.23),(103, 0.15),(170, 0.23)], peaks_vy=[],          peaks_vz=[],
